				...
				<div class="box-right-main">
					...
					<div class="pro-links">
						<div class="pro-links-inner">
							...
							<a class="button-primary bundle-btn" href="<?php echo esc_url( ORGANIC_FARM_BUNDLE_LINK ); ?>" target="_blank"><?php esc_html_e('WordPress Theme Bundle (125+ Themes at Just $99)', 'organic-farm'); ?></a>
					</div>
